...
import { ReactComponent as Art } from 'components/assets/UI_UX.svg'
...
class SolutionsUI extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
    render() {
        return (
            <GridSection className="grid-section inverted-section" gridTemplate={gridTemplateUi}>
                ...
                <GridElement className='tm-border-red' gridTemplate={gridTemplate_Title}>
                    <div className='bolded tm-text-lg'>U<span className='tm-red'>I</span> / U<span className='tm-red'>X</span></div>
                </GridElement>
                ...
                <GridElement className='tm-border-red p-3' gridTemplate={gridTemplate_Interact}>
                    <div className='bolded tm-text-sm'>Design For Me!</div>
                </GridElement>

                <GridElement gridTemplate={gridTemplate_LoremIpsum}>
                    <div className='bolded tm-text-xlg tm-red' style={{ opacity: '0.05', lineHeight: '1' }}>{LoremIpsum}</div>
                </GridElement>
            </GridSection>
        );
    }
